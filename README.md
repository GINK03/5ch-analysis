...
例えば、今回集計した500GByte程度のログからではこのように2005年をピークに、書き込みの中で出てくる頻度がどんどん下がっています。  
若い人がorzを知らないのも、まぁしょうがない、といった感じのネットスラングのようです。
...
感覚と、実際にデータで使われているネットスラング表現には少し隔たりがあったり時代感が不明確であったりした点が整理され、時代の流れについていくことができそうです。  
